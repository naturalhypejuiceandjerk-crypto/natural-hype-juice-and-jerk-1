...
const photoAssets = {
  ...
  "meat-free-salad-box": `${assetBase}/meatF.jpeg`,
  ...
  "mac-n-cheese": `${assetBase}/macn.jpeg`,
  "dumpling": `${assetBase}/dm.jpeg`,
  "barbe-fried-chicken-salad-box": `${assetBase}/bf.jpeg`,
  "sweet-chilli-fried-fish": `${assetBase}/SweetChillyD.jpeg`,
  "FriedChicken": `${assetBase}/SBfriedC.jpeg`,
  ...
  "red-pease-soup": `${assetBase}/rps.jpeg`,
  "berryMix": `${assetBase}/berry.png`,
  "fried-chicken": `${assetBase}/FriedChickenD.jpeg`,
  "pepper-steak": `${assetBase}/PPstakeD.jpeg`,
  "curry-goat": `${assetBase}/CurryGoatD.jpeg`,
  "oxtail": `${assetBase}/OxtailD.jpeg`,
  "fried-fish": `${assetBase}/fish.png`,
  "irish": `${assetBase}/irish.png`,
  "escovitch-fish-bone": `${assetBase}/EscovitchFD.jpeg`,
  "chicken-soup": `${assetBase}/chicken.png`,
  "three-wing-portion": `${assetBase}/FRchicken.png`,
  "seamoss": `${assetBase}/seamoss.jpeg`,
  "barbe-fried": `${assetBase}/BarbeFryD.jpeg`,
  "mix-match-meal-box": `${assetBase}/jerk-chicken-bowl-optimized.webp`,
  "original-jerk-chicken-salad": `${assetBase}/jerk-chicken-salad-bowl-optimized.jpeg`,
  "pineapple-jerk-chicken-salad": `${assetBase}/pineapple-jerk.jpeg`,
  "honey-glazed-chicken-salad": `${assetBase}/honney.jpeg`,
  "fried-chicken-salad-box": `${assetBase}/friedChicken salat.webp`,
  "pepper-steak-salad-box": `${assetBase}/PPstakeD.jpeg`,
  "curry-goat-salad-box": `${assetBase}/CurryGoatD.jpeg`,
  "honey-glazed-chicken-special": `${assetBase}/HoneyGlazeD.jpeg`,
  "curry-jerk-chicken-special": `${assetBase}/chicken.jpeg`,
  "pineapple-jerk-chicken-special": `${assetBase}/pineapple-jerk.jpeg`,
  "curry-oxtail-special": `${assetBase}/OxtailD.jpeg`,
  "beetroot-berries-juice": `${assetBase}/beetroot.png`,
  "carrot-pineapple-ginger-juice": `${assetBase}/pineapple-carrot-ginger.png`,
  ...
  "pineapple-water": `${assetBase}/pineapple-carrot-ginger.png`,
  "carrot-pineapple-ginger-water": `${assetBase}/pineapple-carrot-ginger.png`,
  "kiwi-cucumber-pineapple-water": `${assetBase}/kiwi-cucumber-pineapple-optimized.webp`,
  "fried-chicken-portion": `${assetBase}/FriedChickenD.jpeg`,
  "jerk-chicken-portion": `${assetBase}/JerkChickenD.jpeg`,
  ...
  "honey-glazed-portion": `${assetBase}/HoneyGlazeD.jpeg`,
  "curry-jerk-portion": `${assetBase}/chicken.jpeg`
};
...
function buildOrderReceipt(orderId, customerName, paymentMethod) {
...
function updatePaymentCopy() {
  ...
  if (paymentMethod === "cash") {
    if (paymentDescription) {
      paymentDescription.textContent =
        "Cash orders are sent straight to the restaurant for confirmation.";
    }
    if (checkoutNote) {
      checkoutNote.textContent =
        "Your order will be sent without taking online payment.";
    }
    return;
  }
  ...
  if (checkoutNote) {
    checkoutNote.textContent =
      "Choose cash on collection or try again shortly.";
  }
}
...
async function handleCheckout(event) {
  ...
  if (paymentMethod === "card" && !state.stripeEnabled) {
  ...
  try {
    const response = await fetch(
      paymentMethod === "cash" ? "/api/cash-order" : "/api/create-checkout-session",
      {
      method: "POST",
      headers: {
    ...
    if (result.mode === "stripe" && result.url) {
      window.sessionStorage.setItem(
        "naturalHypeLastOrder",
        JSON.stringify(buildOrderReceipt(result.orderId || "", payload.customer.name, "card"))
      );
      window.location.href = result.url;
      return;
    }
    if (result.mode === "cash") {
      const receipt = buildOrderReceipt(result.orderId || "", result.customerName || payload.customer.name, "cash");
      window.sessionStorage.setItem(
        "naturalHypeLastOrder",
      ...
      updatePaymentCopy();
      const confirmationUrl = new URL("/order-confirmation.html", window.location.origin);
      confirmationUrl.searchParams.set("order", result.orderId || "");
      confirmationUrl.searchParams.set("name", result.customerName || payload.customer.name);
      confirmationUrl.searchParams.set("payment", "cash");
    ...
    submitButton.textContent =
      paymentMethodElement && paymentMethodElement.value === "cash"
        ? "Send order"
        : "Continue to payment";
  }
}
...
function attachEvents() {
  ...
  if (paymentMethodElement) {
    paymentMethodElement.addEventListener("change", () => {
      ...
      if (submitButton) {
        submitButton.textContent =
          paymentMethodElement.value === "cash" ? "Send order" : "Continue to payment";
      }
    });
  }
